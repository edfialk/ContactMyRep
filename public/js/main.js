...
exports.default = {
	...
	created: function created() {
		var self = this;
		_store2.default.fetchPage('about').then(function (val) {
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  var id = "E:\\GreatWorks\\homestead\\ContactMyReps\\resources\\assets\\js\\components\\AboutView.vue"
  if (!module.hot.data) {
...
},{"../store":23,"vue":15,"vue-hot-reload-api":14}],18:[function(require,module,exports){
'use strict';
...
exports.default = {
	...
	methods: {
		submit: function submit() {
			...
			(0, _sweetalert2.default)('Thanks!', 'Your message has been received.', 'success');
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "E:\\GreatWorks\\homestead\\ContactMyReps\\resources\\assets\\js\\components\\ContactView.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"sweetalert":13,"vue":15,"vue-hot-reload-api":14}],19:[function(require,module,exports){
...
exports.default = {
	...
	computed: {
		...
		address: function address() {
			var a = this.item.address;
			if (typeof a == "string") return a;
			if (Array.isArray(a)) return a.join('<br>');
			return '';
		},
		...
		email: function email() {
			if (!this.item.email && !this.item.emails) return '';
			if (typeof this.item.email == "string") return this.item.email;else if (Array.isArray(this.item.emails)) return this.item.emails[0];
			return '';
		},
		website: function website() {
			if (!this.item.website && !this.item.urls) return '';
			if (typeof this.item.website == "string") return this.item.website;else if (Array.isArray(this.item.urls)) return this.item.urls[0];
			return '';
		},
...
},{"superagent":4,"vue":15,"vue-hot-reload-api":14,"vueify-insert-css":16}],20:[function(require,module,exports){
'use strict';
...
exports.default = {
	...
	computed: {
		printSearch: function printSearch() {
			var l = this.location;
			var base = 'Search Results for ';
			if (!l && this.query == '') return '';
			if (!l && this.query != '') return base + decodeURIComponent(this.query);
			if (l.city && l.state_name) return base + l.city + ', ' + l.state_name;
			if (l.address && l.zip) return base + l.address + ', ' + l.zip;
			if (l.zip && l.state_name) return base + l.zip + ' - ' + l.state_name;
			if (l.state_name) return base + l.state_name;
			return '';
		}
	},
	watch: {
		query: function query(val) {
			if (val == '' || val == '/') {
				if (this.geolocation && this.geolocation.latitude && this.geolocation.longitude) {
					this.loading = true;
					_store2.default.fetch(this.geolocation.latitude + '/' + this.geolocation.longitude).then(this.handleResponse);
				} else if (typeof ipinfo !== 'undefined' && ipinfo.loc) {
					this.loading = true;
					var g = ipinfo.loc.split(',');
					_store2.default.fetch(g[0] + '/' + g[1]).then(this.handleResponse);
				}
				return;
			}
			this.loading = true;
			_store2.default.fetch(val).then(this.handleResponse);
		},
	...
	methods: {
		init: function init() {
			if (this.query === '' && typeof ipinfo !== 'undefined' && ipinfo.loc) {
				...
				_store2.default.fetch(this.query).then(this.handleResponse);
			}
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "E:\\GreatWorks\\homestead\\ContactMyReps\\resources\\assets\\js\\components\\QueryView.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"../store":23,"./Item.vue":19,"vue":15,"vue-hot-reload-api":14}],21:[function(require,module,exports){
'use strict';
...
exports.default = {
	...
	created: function created() {
		var self = this;
		_store2.default.fetchPage('terms').then(function (val) {
			self.$el.innerHTML = val;
		});
	}
};
...
if (module.hot) {(function () {  module.hot.accept()
  ...
  hotAPI.install(require("vue"), true)
  if (!hotAPI.compatible) return
  var id = "E:\\GreatWorks\\homestead\\ContactMyReps\\resources\\assets\\js\\components\\TermsView.vue"
  if (!module.hot.data) {
    hotAPI.createRecord(id, module.exports)
  } else {
    hotAPI.update(id, module.exports, (typeof module.exports === "function" ? module.exports.options : module.exports).template)
...
},{"../store":23,"vue":15,"vue-hot-reload-api":14}],22:[function(require,module,exports){
'use strict';
...
var _QueryView = require('./components/QueryView.vue');
...
var _ContactView = require('./components/ContactView.vue');

var _ContactView2 = _interopRequireDefault(_ContactView);

var _TermsView = require('./components/TermsView.vue');
...
_vue2.default.component('about', _AboutView2.default);
_vue2.default.component('query', _QueryView2.default);
_vue2.default.component('contact', _ContactView2.default);
_vue2.default.component('terms', _TermsView2.default);
...
var vm = new _vue2.default({
	...
	events: {
		'message-sent': function messageSent() {
			this.page('');
		}
	},
	watch: {
	...
	methods: {
		...
		locate: function locate() {
			...
			if (navigator.geolocation) {
				navigator.geolocation.getCurrentPosition(function (position) {
					_this.geolocation = position.coords;
					_this.query = _this.geolocation.latitude + '/' + _this.geolocation.longitude;
					document.title = 'Contact My Reps - My Location';
					history.replaceState({}, 'ContactMyReps - My Location', '/');
				}, function () {
					_this.status = 'You must accept location permissions to use your current location.';
				});
			} else {
		...
		page: function page(_page) {
			if (window.location.pathname.substr(1) == _page) {
				return;
			}

			if (this.pages.indexOf(_page) != -1) {
				this.currentView = _page;
				document.title = 'Contact My Reps - ' + _page.charAt(0).toUpperCase() + _page.slice(1);
				history.pushState({}, _page, '/' + _page);
				return;
			}
...
},{"./components/AboutView.vue":17,"./components/ContactView.vue":18,"./components/QueryView.vue":20,"./components/TermsView.vue":21,"./store":23,"vue":15}],23:[function(require,module,exports){
'use strict';
	...
	fetch: function fetch(query) {
		return new Promise(function (resolve, reject) {
			if (cache[query]) {
				...
				$.getJSON(apiroot + query, function (json) {
					var result = cache[query] = json;
					resolve(result);
	...
	fetchPage: function fetchPage(page) {
		return new Promise(function (resolve, reject) {
			if (pageCache[page]) {
				...
				$.get('api/page/' + page, function (html) {
					var result = pageCache[page] = html;
					resolve(html);
				}).fail(function (jqxhr, text, error) {
					reject(text);
				});
