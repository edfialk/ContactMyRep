...
},{"../store":22,"vue":15,"vue-hot-reload-api":14}],18:[function(require,module,exports){
'use strict';
...
exports.default = {
	...
	computed: {
		printSearch: function printSearch() {
			...
			if (!l) return base + decodeURIComponent(this.query);
...
},{"../store":22,"./Item.vue":19,"vue":15,"vue-hot-reload-api":14}],21:[function(require,module,exports){
'use strict';
...
var vm = new _vue2.default({
	...
	methods: {
		...
		page: function page(_page) {
			...
			history.pushState({}, _page, '/' + _page);
			document.title = 'Contact My Reps - ' + _page;
			this.query = _page;
		}
	}
});

},{"./components/AboutView.vue":17,"./components/ContactView.vue":18,"./components/QueryView.vue":20,"./store":22,"vue":15}],22:[function(require,module,exports){
'use strict';
